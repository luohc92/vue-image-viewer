...
function rafThrottle(fn) {
  ...
  return function () {
    ...
    if (locked) return;
    locked = true; // eslint-disable-next-line no-unused-vars
...
function downImage(imgSrc) {
  ...
  image.onload = function () {
    ...
    var imgName = file[file.length - 1];
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./packages/image-viewer/index.vue?vue&type=script&lang=js&
...
var mousewheelEventName = util_isFirefox() ? "DOMMouseScroll" : "mousewheel";
/* harmony default export */ var image_viewervue_type_script_lang_js_ = ({
  ...
  methods: {
    mouseEnterThumbnail: function mouseEnterThumbnail(e) {
    ...
    change: function change(index) {
      ...
      this.curIndex = index;
      var vmEl = this.$refs.thumbnail;
      if (!vmEl) return;
      var width = vmEl.clientWidth;
      var scrollLeft = vmEl.scrollLeft;
      var cur = vmEl.children[index].offsetLeft;
    ...
    handleMouseDown: function handleMouseDown(e) {
      ...
      this._dragHandler = rafThrottle(function (ev) {
        _this.transform.offsetX = offsetX + ev.pageX - startX;
        _this.transform.offsetY = offsetY + ev.pageY - startY;
      });
      on(document, "mousemove", this._dragHandler);
      on(document, "mouseup", function () {
        off(document, "mousemove", _this._dragHandler);
      });
      e.preventDefault();
    },
    deviceSupportInstall: function deviceSupportInstall() {
      ...
      this._mouseWheelHandler = rafThrottle(function (e) {
        ...
        if (_this2.isMouseEnterThumbnail) {
          var moveForwardStep = -1;
          var moveBackStep = 1;
          var step = 0;
          step = delta > 0 ? moveForwardStep * 50 : moveBackStep * 50;
          _this2.$refs.thumbnail.scrollLeft = _this2.$refs.thumbnail.scrollLeft + step;
        } else {
          if (delta > 0) {
            _this2.handleActions("zoomIn", {
              zoomRate: 0.015,
    ...
    initOptions: function initOptions(options) {
      ...
      setTimeout(function () {
        _this4.thumbnailTransitionShow = true;
      }, 1);
    }
  }
});
...
var ImageViewerCtor = external_commonjs_vue_commonjs2_vue_root_Vue_default.a.extend(image_viewer);
function imageViewer() {
  var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultOptions;
  var instance = new ImageViewerCtor();
  instance.initOptions(_objectSpread2(_objectSpread2({}, defaultOptions), options));
  instance.$mount();
...
/******/ });
//# sourceMappingURL=vue-image-viewer.common.js.map